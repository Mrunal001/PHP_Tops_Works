    ...
    <h2 align="center">Add City</h2>
        ...
        <div class="jumbotron" style="padding:25px; height:200px">
            ...
            <div class="form-group col-md-7">
                    <select  name="sname"  class="form-control" placeholder="Enter State Name*" data-bvalidator="required">
                ...
                <div class="form-group col-md-7">
                    <input type="text" name="ctname"  class="form-control" placeholder="Enter City Name*" data-bvalidator="required">
                </div>
                <div class="form-group col-md-7">
                    <input type="submit" name="addcity" class="btn btn-lg btn-danger" value="AddCity">
                </div>
