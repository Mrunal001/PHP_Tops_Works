<?php
$mainurl="http://localhost/Bookbarter/";
...
<html lang="zxx">
 <head>        
        ...
        <!-- Title -->
        <title>Book Barter | Exchange Your Books Online</title>
        
        <!-- Favicon -->
        <link href="<?php echo $baseurl;?>images/favicon.ico" rel="icon" type="image/x-icon" />
        
        <!-- Fonts -->
        <link href="<?php echo $baseurl;?>https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i%7CLato:100,100i,300,300i,400,400i,700,700i,900,900i" rel="stylesheet" />
        <link href="<?php echo $baseurl;?>css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        
        <!-- Mobile Menu -->
        <link href="<?php echo $baseurl;?>css/mmenu.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo $baseurl;?>css/mmenu.positioning.css" rel="stylesheet" type="text/css" />
        ...
        <!-- Mobile Menu -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/mmenu.min.js"></script>
        
        <!-- Harvey - State manager for media queries -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/harvey.min.js"></script>
        
        <!-- Waypoints - Load Elements on View -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/waypoints.min.js"></script>

        <!-- Facts Counter -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/facts.counter.min.js"></script>

        <!-- MixItUp - Category Filter -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/mixitup.min.js"></script>

        <!-- Owl Carousel -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/owl.carousel.min.js"></script>
        
        <!-- Accordion -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/accordion.min.js"></script>
        
        <!-- Responsive Tabs -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/responsive.tabs.min.js"></script>
        
        <!-- Responsive Table -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/responsive.table.min.js"></script>
        
        <!-- Masonry -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/masonry.min.js"></script>
        
        <!-- Carousel Swipe -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/carousel.swipe.min.js"></script>
        
        <!-- bxSlider -->
        <script type="text/javascript" src="<?php echo $baseurl;?>js/bxslider.min.js"></script>
                            ...
                            <div class="col-md-3">
                                <div class="navbar-header">
                                    <div class="navbar-brand">
                                        <h1>
                                            <a href="index-2.html">
                                                <img src="<?php echo $baseurl;?>images/libraria-logo-v1.png" alt="LIBRARIA" />
                                            </a>
                                        </h1>
                                    </div>
                                </div>
