...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2020 at 05:44 AM
...
INSERT INTO `tbl_cart` (`cartid`, `courseid`, `emplid`, `coursename`, `qty`, `price`, `subtotal`, `added_date`, `status`) VALUES
(1, 3, 3, 'ReatJs', 1, 78000, 78000, '12/14/20 10:14:07', 'pending');
...
(3, 'uploads/aspnet.jpg', 'mohit', 'pandya', 'mohit@gmail.com', 'MTIzNDU=', 'rajkot', 9173357217, 1, 1, 1, '12/14/20 09:24:54');
