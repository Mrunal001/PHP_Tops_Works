...
<!--logo start-->
<div class="brand">
    <a href="<?php echo $mainurl;?>Dashboard" class="logo">
        Admin
    </a>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"> <?php echo ucfirst($_SESSION["em"]);?></span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <!-- <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li> -->
                <!-- <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li> -->
                <li><a href="<?php echo $mainurl;?>?Adminlogout" onclick="return confirm('Are You sure to Logout as Admin ?')"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
...
<!-- calendar -->
	<script type="text/javascript" src="<?php echo $baseurl;?>js/monthly.js"></script>
