                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="col-md-8 col-xs-12">
                            ...
                            <div class="well wll-lg">
                                <h2 align="center" style="color: black;">Admin Login</h2>
                                <form method="POST" id="frm2">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" name="log" value="Login" class="btn btn-block btn-info">

                                        <a href="<?php echo $mainurl;?>ForgetPassword">
