...
<p align="justify">Contact with us Our admin will contact with you within 5 days working and your details successfully send in Our admin Too >></p>
<center>
...
<div class="form-group">
<label>Message *</label>
<textarea  name="message" placeholder="Message *" class="form-control @error('message') is-invalid @enderror" autocomplete="message" autofocus>{{ old('message') }}</textarea>
@error('message')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
